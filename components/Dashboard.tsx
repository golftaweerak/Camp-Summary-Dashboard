        ...
        <div id="mainView" className="max-w-7xl mx-auto">
            <header className="mb-10">
                <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    />
                    <div>
                        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-slate-800">สรุปผลการดำเนินงาน</h1>
                        <p className="mt-2 text-xl text-slate-600">ค่าย 1 สอวน.วิชาดาราศาสตร์ ศูนย์โรงเรียนพรหมานุสรณ์จังหวัดเพชรบุรี</p>
                    </div>
                </div>
                <div className="mt-6">
                    <button
            ...
            <section className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-slate-700">ภาพรวมความพึงพอใจในด้านต่าง ๆ (Overall Average)</h2>
                <p className="mt-4 text-xl text-slate-600"> (คะแนนเต็ม 5) </p>
            ...
            <section className="mb-10">
                 <h2 className="text-2xl font-bold mb-4 text-slate-700">สรุปด้านงบประมาณ (Financial Summary)</h2>
                 <FinancialSummaryCard metrics={FINANCIAL_METRICS} onSelect={() => onSelectDetail('financial')} />
            </section>

            <section className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-slate-700">ข้อเสนอแนะสำคัญ (Key Feedback)</h2>
                <FeedbackSection />
            </section>
        </div>
    );
